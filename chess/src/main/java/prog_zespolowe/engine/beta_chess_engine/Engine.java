package prog_zespolowe.engine.beta_chess_engine;
...
import prog_zespolowe.engine.eval_function.Evaluator;
...
//         return negatedMinMax(board, depth);
     ...
     * (Working)
     */
    public static EngineEval negatedMinMax(Board board, int depth) {
        if (depth == 0) {
...
//            return Evaluator.evaluate(board); // Working
     ...
     */
    public static EngineEval alphaBetaMax(Board board, int alpha, int beta, int depth) {
