      ...
      {loading ? 
        ...
        <div> 
          ...
          <div className="description" style={{color: theme === "lightmode" ? "var(--primary)" : "var(--secondary)"}}>
            ...
            You can also play with your friends on the same device using the <b>Play 1 vs 1 (offline)</b> mode. <br />
            If you'd like to have a go at playing against a professional chess engine (Stockfish), choose <b>Play vs computer</b>. <br />
            In the section <b>Play vs our chess AI</b> you can play against an experimental engine that we created from scratch.<br /> <br />

            If you feel like learning something new, visit <b>Watch games</b> and <b>Analyze Games</b> sections. There you can <br />
            watch other players' games and try to draw conclusions, either on your own or with the help of a chess engine. <br /> <br />

            If you like more extraordinary challenges that require strategic thinking, you can open the <b>Puzzles</b> section. <br />
            ...
            You can also find out how good you are at chess and compare yourself to other users by checking <br />
            your position in our <b>Leaderboards</ b>. <br /> <br />

            Do you want to give us some feedback or report a bug? Go to the <b>Feedback</b> tab and share your opinion with us. <br/>
