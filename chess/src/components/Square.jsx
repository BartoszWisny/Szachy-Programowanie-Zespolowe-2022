  ...
  return ( /* add different types of board - vscomputer, 1vs1offline, etc. */
    <div className={`${background} chessboardsquare`}>
      ...
      {position ? <div>
        ...
        : (boardtype === "vsourchessai" ? (playerPieces === "w" ? "min(0.1rem, min(0.225vh, 0.225vw))" : "min(3.5rem, min(7.875vh, 7.875vw))") 
        ...
        : (boardtype === "vsourchessai" ? (playerPieces === "w" ? "min(0.3rem, min(0.675vh, 0.675vw))" : "min(4.2rem, min(9.45vh, 9.45vw))") 
        ...
        : (boardtype === "vsourchessai" ? (playerPieces === "w" ? "min(0.2rem, min(0.45vh, 0.45vw))" : "min(3.6rem, min(8.1vh, 8.1vw))") 
        ...
        : (boardtype === "vsourchessai" ? (playerPieces === "w" ? "min(0.3rem, min(0.675vh, 0.675vw))" : "min(4.1rem, min(9.225vh, 9.225vw))") 
        : "min(0.3rem, min(0.675vh, 0.675vw))"), 
