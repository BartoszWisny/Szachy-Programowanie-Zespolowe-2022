  ...
  return (
    <div className={`${background} chessboardsquare`}>
      ...
      {position ? <div>
        ...
        top: boardtype === "1vs1offline" ? (turn === "w" ? "0.1rem" : "3.5rem") 
        : (boardtype === "vsourchessai" ? (playerPieces === "w" ? "0.1rem" : "3.5rem") 
        : "0.1rem"), 
        left: boardtype === "1vs1offline" ? (turn === "w" ? "0.3rem" : "4.2rem") 
        : (boardtype === "vsourchessai" ? (playerPieces === "w" ? "0.3rem" : "4.2rem") 
        : "0.3rem")}}>{number}</h2>
        <h2 className="letter" style={{color: dark ? "var(--lightsquare)" : "var(--darksquare)", 
        bottom: boardtype === "1vs1offline" ? (turn === "w" ? "0.2rem" : "3.6rem") 
        : (boardtype === "vsourchessai" ? (playerPieces === "w" ? "0.2rem" : "3.6rem") 
        : "0.2rem"), 
        right: boardtype === "1vs1offline" ? (turn === "w" ? "0.3rem" : "4.1rem") 
        : (boardtype === "vsourchessai" ? (playerPieces === "w" ? "0.3rem" : "4.1rem") 
        : "0.3rem")}}>{letter}</h2>
      </div> : null}
    </div>
  )
